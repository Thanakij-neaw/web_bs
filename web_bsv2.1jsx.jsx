        ...
        <div className="relative mx-auto flex min-h-[750px] max-w-7xl items-center px-6 py-24">
          <div className="max-w-4xl text-white">
            ...
            <div className="mt-12 flex flex-wrap gap-5">
              <button className="rounded-2xl bg-yellow-400 px-8 py-5 text-lg font-black text-black shadow-2xl transition hover:scale-105">
                จองศึกษาดูงาน
              </button>

              <button className="rounded-2xl border border-white/30 bg-white/10 px-8 py-5 text-lg font-bold backdrop-blur transition hover:bg-white hover:text-black">
                ดูหลักสูตรอบรม
              </button>
            </div>
          </div>
